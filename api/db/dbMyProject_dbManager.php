...
function getConnection() {
	...
	global $db_MyProject_db_Url, $db_MyProject_db_User, $db_MyProject_db_Pass, $db_MyProject_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_MyProject_db_Url.";dbname=".$db_MyProject_db_DbName, $db_MyProject_db_User, $db_MyProject_db_Pass);
